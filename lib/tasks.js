...
const REFUSAL_PREFIXES = [
  // English
  'i cannot', "i can't", 'i am unable', "i'm unable", 'sorry', 'i apologize',
  "i don't have", 'i do not have', 'as an ai', 'as a language model',
  // Chinese
  '我无法', '我不能', '抱歉', '对不起', '作为一个ai', '作为ai', '很抱歉',
  // Russian
  'извините', 'извини', 'простите', 'я не могу', 'к сожалению', 'как ии',
  // Arabic
  'عذراً', 'عذرا', 'آسف', 'أعتذر', 'لا أستطيع', 'لا يمكنني',
];
