...
function normalize(s) {
  ...
  t = t.replace(/\.+$/, '').trim();
  // lowercase (most answers are case-insensitive)
  t = t.toLowerCase();
  if (t.length === 0 || t.startsWith('i cannot') || t.startsWith('sorry') || t.startsWith('i apologize') || t.startsWith('i don\'t have') || t.startsWith('as an ai')) return null;
  return t;
}
